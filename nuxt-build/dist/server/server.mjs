...
import require$$0, { reactive as reactive$1, getCurrentInstance, ref as ref$1, defineComponent, useSSRContext, resolveComponent, mergeProps, createApp } from "vue";
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr } from "vue/server-renderer";
...
const vueuseHead_5e7a973d = defineNuxtPlugin((nuxt) => {
...
const plugin_0f386931 = defineNuxtPlugin((nuxtApp) => {
...
const _imports_0 = "/_nuxt/seabg.mp4";
const _imports_1 = "/_nuxt/deepworks-logo.png";
const app_vue_vue_type_style_index_0_lang = "";
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><video id="bgvid" playsinline autoplay muted loop><source${ssrRenderAttr("src", _imports_0)} type="video/mp4"></video><header class="viewport-header"><img${ssrRenderAttr("src", _imports_1)}><p>Building tools for you to go deeper on fitness and focus.</p></header></div>`);
}
